...
class ContractDefinition extends Component<IContractRouterProps> {
	...
	public async componentDidMount() {
		...
		if (etherscanResult && etherscanResult.length > 0) {
			...
			const etherContract = new ethers.Contract(this.props.contractAddress, contract.ABI, this.provider);
	...
	public render() {
		...
		if (this.state.name === "") {
			notFound = (
				<div className="contract-summary text-center">
				...
				<div>
					<div className="contract-summary">
						...
						<h3>
							{this.state.address}
							<small>
								<a href={"https://etherscan.io/address/" + this.state.address} className="text-secondary" target="_blank">
